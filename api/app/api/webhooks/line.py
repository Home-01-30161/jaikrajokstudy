...
_OCR_PROMPT = (
    ...
    "4. ถ้าโจทย์เป็นฟิสิกส์หรือคณิตศาสตร์ ให้แสดงวิธีแก้โจทย์พร้อมเฉลยคำตอบสุดท้าย\n"
    "5. ห้ามซ้ำเนื้อหาเดิม ห้ามวนซ้ำขั้นตอน — เฉลยครั้งเดียว จบในคำตอบเดียว\n"
    "6. ตอบกระชับ ไม่เกิน 300 คำ"
)
_NO_FACE_PHRASE = (
